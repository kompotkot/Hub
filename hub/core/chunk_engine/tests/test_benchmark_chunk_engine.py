...
from hub.tests.common_benchmark import (
    ...
    parametrize_benchmark_num_batches, parametrize_benchmark_threads,
)
...
def single_benchmark_read(key, storage, multi_threaded):
    read_array(key, storage, multi_threaded=multi_threaded)


def benchmark_read(benchmark, shape, dtype, chunk_size, num_batches, storage, multi_threaded):
    """
    ...
    benchmark(single_benchmark_read, actual_key, storage, multi_threaded)
    storage.clear()
...
def test_read_with_caches(
    ...
    benchmark_read(benchmark, shape, dtype, chunk_size, num_batches, storage, multi_threaded)
